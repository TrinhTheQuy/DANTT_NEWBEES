...
public class UIOperation {
	...
	public void perform(Properties p,String operation,String objectType,String objectName,String value) throws Exception{
		System.out.println("");
		...
		case "GETTEXT":
			...
			driver.findElement(this.getObject(p,objectType,objectName)).getText();
			break;
